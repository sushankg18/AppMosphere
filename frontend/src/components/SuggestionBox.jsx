import { Box, Button, Center, Circle, Flex, Heading, Image, Spinner, Text } from '@chakra-ui/react'
                    ...
                    </Link>
                    {
                      isFollowing ?
                        <Button
                          ...
                          size={'xs'}
                          fontWeight={'bold'}>
                          {buttonLoadingId === item._id ? <Spinner size={'sm'}/> : "Following"}
                        </Button>
                        :
                        <Button
                          onClick={() => handleFollow(item._id)}
                          ...
                          w={'6rem'}
                          color={'white'}
                          _hover={{ bgColor: "rgb(70, 70, 70)" }}
                          p={' .9rem'}
                          fontSize={'.9rem'}
                          size={'xs'}
                          fontWeight={'bold'}
                          >
                          {buttonLoadingId === item._id ? <Spinner size={'sm'} /> : "Follow"}
                        </Button>
                    }
                  </Flex>
                </Flex >
